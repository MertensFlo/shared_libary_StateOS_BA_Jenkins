class StageBuild {
    ...
    void build(boolean git, boolean wget, boolean xz_utils, boolean arm, boolean build_essential, boolean apt_utils, boolean ninja, String workingOrg, String workingRepo, String arm_version){
